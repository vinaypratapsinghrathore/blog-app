...
const Page = ({ params }) => {
    ...
    useEffect(() => {
        const unwrapParams = async () => {
            const unwrapped = await params; // Await the params to resolve the Promise
            setResolvedParams(unwrapped); // Store the resolved params in state
        };
        unwrapParams();
    }, [params]);
            ...
            <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
                <div className='flex justify-between items-center'>
                    ...
                    <button className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border:black shadow-[-7px_7px_0px_#000000]'>
                        ...
                        <Image 
                            src={assets.arrow} 
                            alt="Arrow pointing right"  // Add alt text for the arrow image
                        />
                    </button>
                </div>
  ...
  <p className="my-3">
    Before your lifestyle, you must have a clear understanding of what you want
    to achieve. Start by reflecting on your values, aspirations, and long-term
    goals.
  </p>
  <h3 className="my-5 text-[18px] font-semibold">
  ...
  <p className="my-3">
    Manging your lifestyle is a journey that requires commitment and self-awareness.By following this step-by-step guide, you can take control of your life and make meaninful changes that lead to a more balanced and fulfilling lifestyle.Remember that its's okay to seek support and guidance from professionals or mentors along the way.
